...
function goKeyboard() {
  ...
  resizeHandler();
    ...
    var instruments = [{
        ...
        fileName: "sine",            fade: 0.1 }, {
        fileName: "triangle",        fade: 0.1 }, {
        fileName: "trapezium",       fade: 0.1 }, {
        fileName: "square",          fade: 0.1 }, {
    ...
    //console.log(instruments[instrumentOption].fileName);
  ...
  //iPad Shake to toggle sustain
    if (typeof window.DeviceMotionEvent != 'undefined') {
      ...
      setInterval(function() {
        ...
        change = 0; //Comment this line to turn on systain again;
